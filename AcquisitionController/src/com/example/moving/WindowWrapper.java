...
public class WindowWrapper {
	...
	private double theta_old;
	
	private WindowWrapper(int size,double slide,double frequency){
	...
	private boolean isAvailableWindow(double x,double y,double z){
	...
	private void setWindowQueue(IBaseFeature base){
